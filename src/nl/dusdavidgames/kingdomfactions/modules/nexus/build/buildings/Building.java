...
//		Messages.getInstance().debug("Set paste location to " + Utils.getInstance().getLocationString(paste));
    ...
    public double getDistance(KingdomFactionsPlayer p) {
        ...
        Location nexusLocation = Utils.getInstance().getNewLocation(this.getLocation());
        player.setY(0);
        nexusLocation.setY(0);
        return nexusLocation.distance(player);
    }
    ...
    public double getDistance(Location location) {
        ...
        loc.setY(0);
        nexusLocation.setY(0);
        return nexusLocation.distance(loc);
    }
