...
import nl.dusdavidgames.kingdomfactions.KingdomFactionsModule;
...
public class BookModule extends KingdomFactionsModule {

    public BookModule(KingdomFactionsPlugin plugin) {
        super(plugin);
        instance = this;
    }
    ...
    @Getter
    private static BookModule instance;
