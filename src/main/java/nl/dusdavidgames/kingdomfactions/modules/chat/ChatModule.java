...
public class ChatModule {
	...
	public ChatModule() {
		...
		new ReplyCommandExecutor("reply", "kingdomfactions.command.reply", "Reageer op een Priv� Bericht", "r [bericht]", false, false).registerCommand();
		new MsgCommandExecutor("msg", "kingdomfactions.command.msg", "Stuur een Priv� Bericht", "msg [speler] [bericht]", false, false).registerCommand();
